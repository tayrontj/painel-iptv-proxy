...
import { getCustomerSubscriptionSignal, getDaysUntilExpiry, getSubscriptionStatus } from "@/lib/panelModel";
...
export function CustomerActions({ customer, onChangeStatus }: CustomerActionsProps) {
  ...
  const effectiveStatus = getSubscriptionStatus(customer.status, customer.expiresAt);
